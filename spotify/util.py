...
def get_user_tokens(session_id):
    # check if there are any tokens associate with user
...
def update_or_create_user_tokens(session_id, access_token, token_type, expires_in, refresh_token):
    ...
    expires_in = timezone.now() + timedelta(seconds=expires_in) # expires_in is in seconds, change this value into a timestamp
